...
import { registerIngestPipelineQueue, registerIngestPipelineWorker } from './jobs/ingest-pipeline';
import { startDmStagingSweeper } from './jobs/dm-sweeper';
...
(async () => {
  ...
  await registerIngestPipelineWorker();
  startDmStagingSweeper();
